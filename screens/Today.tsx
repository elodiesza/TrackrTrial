...
const Today = ({db, tasks, setTasks, tags, setTags, states, setStates, moods, setMoods, load, loadx}) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Swiper horizontal={false} showsButtons={false} showsPagination={false} loop={false}>
        <TodayScreen db={db} tasks={tasks} setTasks={setTasks} tags={tags} setTags={setTags} states={states} setStates={setStates} moods={moods} setMoods={setMoods} load={load} loadx={loadx}/>
